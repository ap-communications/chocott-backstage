...
![Install App Target](../images/orgl-github-app-install-target.png)
...
Installボタンをクリックすると、インストールしたGitHub Appの画面に遷移します。  
これでGitHub Appのインストールは完了です。

![Installed GitHub App overview](../images/org-github-app-after-installing-overview.png)
