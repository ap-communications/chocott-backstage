...
## Organizationアカウント向け：GitHub App Credentialの設定
...
こちらのファイルをコピーして、Credentialファイルを作成します。
...
-  [Organizationアカウントでchocott-backstageを立ち上げる](../quick-start/organization.md)で作業をされていた方は、[3. 環境変数の設定](../quick-start/organization.md#3-環境変数の設定)の手順から作業を続けてください。