...
このリポジトリのトップディレクトリに `github-credentials.yaml.sample` というCredentialファイルのテンプレートがあります。こちらのファイルをコピーして、Credentialファイルを作成します。
...
作成が完了したら、GITHUB_CREDENTIAL_FILE 環境変数にgithub-credentials.yamlのパス名を指定してください。
